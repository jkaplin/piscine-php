...
class Matrix
{
	...
	{
			$this->identity(1);
			$this->matrix[3] = $this->_vtc->x;
			$this->matrix[7] = $this->_vtc->y;
			$this->matrix[11] = $this->_vtc->z;
	}
	...
	{
			$tmp = array();
			$tmp['x'] = ($vtx->x * $this->matrix[0]) + ($vtx->y * $this->matrix[1]) + ($vtx->z * $this->matrix[2]) + ($vtx->w * $this->matrix[3]);
			$tmp['y'] = ($vtx->x * $this->matrix[4]) + ($vtx->y * $this->matrix[5]) + ($vtx->z * $this->matrix[6]) + ($vtx->w * $this->matrix[7]);
			$tmp['z'] = ($vtx->x * $this->matrix[8]) + ($vtx->y * $this->matrix[9]) + ($vtx->z * $this->matrix[10]) + ($vtx->w * $this->matrix[11]);
			$tmp['w'] = ($vtx->x * $this->matrix[11]) + ($vtx->y * $this->matrix[13]) + ($vtx->z * $this->matrix[14]) + ($vtx->w * $this->matrix[15]);
			$tmp['color'] = $vtx->color;
